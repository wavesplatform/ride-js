...
describe('dataTransaction - getBoolean / getBooleanValue',  () => {
    ...
    test.each([
        ...
        [data.STDLIB_VERSION_5, getBooleanIndex, data.GreaterV3ResultBooleanEntry, data.booleanEntryForTests, data.POSITIVE_TEST],
        ...
        [data.STDLIB_VERSION_5, getBooleanValueKey, data.GreaterV3ResultBooleanEntry, data.booleanEntryForTests, data.POSITIVE_TEST],
        ...
        [data.STDLIB_VERSION_5, getBooleanValueIndex, data.GreaterV3ResultBooleanEntry, data.booleanEntryForTests, data.POSITIVE_TEST],
