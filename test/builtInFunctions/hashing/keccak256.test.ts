...
describe('keccak256 Range of functions.',  () => {
    ...
    test.each([
        ...
        [data.STDLIB_VERSION_3, invalidKeccak256, random.getRandomAddress(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_4, invalidKeccak256, random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidKeccak256, random.getRandomInt(), data.NEGATIVE_TEST],
        ...
        [data.STDLIB_VERSION_4, invalidKeccak256_16Kb, random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidKeccak256_16Kb, random.getRandomInt(), data.NEGATIVE_TEST],
        ...
        [data.STDLIB_VERSION_4, invalidKeccak256_32Kb, random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidKeccak256_32Kb, random.getRandomInt(), data.NEGATIVE_TEST],
        ...
        [data.STDLIB_VERSION_4, invalidKeccak256_64Kb, random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidKeccak256_64Kb, random.getRandomInt(), data.NEGATIVE_TEST],
        ...
        [data.STDLIB_VERSION_4, invalidKeccak256_128Kb, random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidKeccak256_128Kb, random.getRandomInt(), data.NEGATIVE_TEST],
