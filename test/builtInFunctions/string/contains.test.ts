...
describe('contains functions',  () => {
    ...
    const invalidContainsArgBeforeFunc = `foo.contains()`;
    ...
    test.each([
        ...
        // contains arguments before functions
        [data.STDLIB_VERSION_4, containsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.POSITIVE_TEST],
        [data.STDLIB_VERSION_5, containsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.POSITIVE_TEST],
        [data.STDLIB_VERSION_6, containsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.POSITIVE_TEST],
        // invalid data contains
        [data.STDLIB_VERSION_4, containsArgBeforeFunc, random.getRandomAlias(), data.intList, data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, containsArgBeforeFunc, random.getRandomIssue(), data.stringList, data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_6, containsArgBeforeFunc, random.getRandomInt(), data.stringList, data.NEGATIVE_TEST],
        // invalid function contains
        [data.STDLIB_VERSION_4, invalidContainsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidContainsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_6, invalidContainsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.NEGATIVE_TEST],
        // Can't find a function 'contains' for ride v3
        [data.STDLIB_VERSION_3, containsArgBeforeFunc, random.getRandomString(), random.getRandomString(), data.NEGATIVE_TEST],
