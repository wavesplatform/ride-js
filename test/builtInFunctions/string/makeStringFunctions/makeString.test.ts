...
describe('makeString functions',  () => {
    ...
    const invalidMakeStringArgBeforeFunc = `foo.makeString()`;
    ...
    test.each([
        ...
        // makeString argument before function
        [data.STDLIB_VERSION_4, makeStringArgBeforeFunc, random.getRandomString(), data.stringList, data.POSITIVE_TEST],
        [data.STDLIB_VERSION_5, makeStringArgBeforeFunc, random.getRandomString(), data.stringList, data.POSITIVE_TEST],
        [data.STDLIB_VERSION_6, makeStringArgBeforeFunc, random.getRandomString(), data.stringList, data.POSITIVE_TEST],
        // invalid data makeString
        [data.STDLIB_VERSION_4, makeStringArgBeforeFunc, random.getRandomInt(), data.stringList, data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, makeStringArgBeforeFunc, random.getRandomInt(), data.stringList, data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_6, makeStringArgBeforeFunc, random.getRandomInt(), data.stringList, data.NEGATIVE_TEST],
        // invalid function makeString
        [data.STDLIB_VERSION_4, invalidMakeStringArgBeforeFunc, random.getRandomAlias(), random.getRandomString(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_5, invalidMakeStringArgBeforeFunc, random.getRandomIssue(), random.getRandomAlias(), data.NEGATIVE_TEST],
        [data.STDLIB_VERSION_6, invalidMakeStringArgBeforeFunc, random.getRandomIssue(), random.getRandomAlias(), data.NEGATIVE_TEST],
        // Can't find a function 'makeString' for ride v3
        [data.STDLIB_VERSION_3, makeStringArgBeforeFunc, random.getRandomString(), data.stringList, data.NEGATIVE_TEST],
